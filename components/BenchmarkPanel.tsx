  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        {kospi && (
          <>
            <div className="ui-inner-block">
              <p className="text-xs text-zinc-300">KOSPI 지수</p>
              <p className="mt-1 text-lg font-bold tabular-nums">{kospi.price.toFixed(2)}</p>
            </div>
            <div className="ui-inner-block">
              <p className="text-xs text-zinc-300">KOSPI 전일比</p>
              <p
        ...
        {cmp.portfolio != null && (
          <div className="ui-inner-block">
            <p className="text-xs text-zinc-300">보유 종목 가중 전일比</p>
        ...
        {cmp.alpha != null && (
          <div className="ui-inner-block">
            <p className="text-xs text-zinc-300">KOSPI 대비 초과</p>
